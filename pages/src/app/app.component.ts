...
export class AppComponent {
  ...
  images = [
    ...
    },
    {
      title: 'Surfing',
      url:
        'https://images.unsplash.com/photo-1502680390469-be75c86b636f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60',
    },
    {
  ...
  checkWindowIndex(i: number): boolean {
